...
Since we only have 100 training images we increased our training set by (please also see section [1.2 Download the data](#12-download-the-data) to get the following directories):
